...
/* LQ3A: Silence Microsofts cross-platform noise. */
#ifdef _MSC_VER
...
/* LQ3A: Silence intentional unreferenced parameters
	when compiling with warning level 4. */
...
/* LQ3A: This escape sequence reverts back to the initial call color. */
#define COLOR_REVERT	'8'
...
/* LQ3A: This escape sequence reverts back to the initial call color.
	Drawn as black by functions which do not support it. */
#define S_COLOR_REVERT	"^8"
...
/* LQ3A: Change return from void to int. */
