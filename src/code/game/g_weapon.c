...
qboolean CheckGauntletAttack( gentity_t *ent ) {
	...
	/* LQ3A */
	damage = (g_damageGauntlet.integer > 0) ? g_damageGauntlet.integer : 0;
	damage *= s_quadFactor;
...
/* LQ3A: Removed MACHINEGUN_SPREAD, MACHINEGUN_DAMAGE and MACHINEGUN_TEAM_DAMAGE definitions. */
...
/* LQ3A: Removed DEFAULT_SHOTGUN_DAMAGE definition. */
...
void weapon_railgun_fire (gentity_t *ent) {
	...
	/* LQ3A */
	damage = (g_damageRail.integer > 0) ? g_damageRail.integer : 0;
	damage *= s_quadFactor;
...
void Weapon_HookFree (gentity_t *ent)
{
	...
	/* LQ3A: Allow the hook to fire again straight away. */
...
void Weapon_LightningFire( gentity_t *ent ) {
	...
	/* LQ3A */
	damage = (g_damageLightning.integer > 0) ? g_damageLightning.integer : 0;
	damage *= s_quadFactor;
