...
/* LQ3A: Moved from bg_misc.c due to updates the
	shared content which is not needed for the ui build. */

//
// bg_items.c -- both games misc functions, all completely stateless
