...
/* LQ3A */
vmCvar_t	cg_version;
vmCvar_t	cg_spectatorPassword;
vmCvar_t	cg_hookColor;
...
static cvarTable_t cvarTable[] = { // bk001129
	...
	/* LQ3A: Added to the userinfo string so that we can replicate the camera position on the server side
		when switching from SPECTATOR_FOLLOW to SPECTATOR_FOLLOW_THIRDPERSON. */
	{ &cg_thirdPersonRange, "cg_thirdPersonRange", "100", CVAR_CHEAT|CVAR_USERINFO },
	{ &cg_thirdPersonAngle, "cg_thirdPersonAngle", "0", CVAR_CHEAT|CVAR_USERINFO },
	...
	/* LQ3A: Communicated to server via userinfo,
		style is set per client not globally however it can be forced by the server. */
...
//	{ &cg_pmove_fixed, "cg_pmove_fixed", "0", CVAR_USERINFO | CVAR_ARCHIVE },
	...
	/* LQ3A */
	{&cg_version,			"cg_version",		LQ3A_VERSION,	CVAR_ROM},
	{&cg_spectatorPassword, "cg_spectatorPass",	"",				CVAR_ARCHIVE|CVAR_USERINFO},
	{&cg_hookColor,			"cg_hookColor",		"4",			CVAR_ARCHIVE|CVAR_USERINFO}
};
...
=================
*/
/* LQ3A: Removed static declaration. */
...
static void CG_RegisterGraphics( void ) {
	...
	/* LQ3A */
	cgs.media.regenWeaponShader = trap_R_RegisterShader("powerups/lq3a_regenWeapon");
	cgs.media.protectionShader = trap_R_RegisterShader("powerups/lq3a_protection");
	cgs.media.protectionWeaponShader = trap_R_RegisterShader("powerups/lq3a_protectionWeapon");
	...
	/* LQ3A */
	cgs.media.camping = trap_R_RegisterShaderNoMip("lq3a_camping");
