...
static void CG_ScoresDown_f( void ) {
	...
	/* LQ3A */
	LQ3A_LayoutKeyDown(LQ3A_LAYOUT_SCOREBOARD);
...
static void CG_ScoresUp_f( void ) {
	...
	/* LQ3A */
	LQ3A_LayoutKeyUp(LQ3A_LAYOUT_SCOREBOARD);
...
static void CG_scrollScoresDown_f( void) {
	/* LQ3A */
	if (menuScoreboard && (cg.iLayout == LQ3A_LAYOUT_SCOREBOARD)) {
...
static consoleCommand_t	commands[] = {
	...
	/* LQ3A */
	{"motd",		LQ3A_MotdCmd},
	{"+hiscores",	LQ3A_HighScoreDownCmd},
	{"-hiscores",	LQ3A_HighScoreUpCmd}
};
